...
import { addExpiryFlags, parseDate } from "../utils/vehicleDates";
import {
  createVehicle,
  deleteVehicle,
  getVehicles,
...
function getVehicleUrgencyRank(vehicle) {
  if (
...
function getNearestDeadlineTime(vehicle) {
  const deadlineDates = [
    vehicle.scadenza_bollo,
    vehicle.scadenza_assicurazione,
    vehicle.scadenza_revisione,
...
function sortVehiclesByUrgency(vehiclesToSort) {
